...
The kinematics Update model equation shown below
![alt text][image1]
...
As an actuation command we have steering angle and throttle value. This values for each step is calculated by predicting trajectory in 3rd order equation along with minimizing cost.
actutor constraints has been added as well which are shown below
![alt text][image2]
